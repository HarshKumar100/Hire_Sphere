...
const Notifications = () => {
  ...
  const getNotificationIcon = (type) => {
    ...
    switch (type) {
      ...
      case 'application_accepted':
        return <IoCheckmark className={iconClass} size={20} />;
      case 'application_rejected':
        return <IoCloseCircle className={iconClass} size={20} />;
      case 'shortlisted':
        return <IoStar className={iconClass} size={20} />;
      case 'stage_update':
        return <IoStatsChart className={iconClass} size={20} />;
      default:
  ...
  const handleNotificationClick = (notification) => {
    ...
    if (notification.type === 'drive_announcement') {
      navigate('/student/drives');
    } else if (notification.type === 'application_update' || notification.type === 'shortlisted' || notification.type === 'stage_update') {
      navigate('/student/applications');
    } else if (notification.type === 'offer_received') {
      navigate('/student/offers');
    } else if (notification.type === 'interview_schedule') {
      navigate('/student/applications');
      ...
      <FadeIn>
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-primary-600 mt-1">Stay updated with your placement activities</p>
          </div>
          <Button
