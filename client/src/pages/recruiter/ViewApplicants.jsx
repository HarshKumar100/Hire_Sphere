      ...
      <FadeIn>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              icon={<IoSparkles />}
              onClick={() => navigate(`/recruiter/drives/${id}/shortlist`)}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="p-3 bg-primary-50 rounded-lg">
                <h3 className="text-xs font-medium text-primary-500 mb-1">LinkedIn</h3>
                {selectedApplicant.studentId?.linkedIn ? (
                  <a href={selectedApplicant.studentId.linkedIn} target="_blank" rel="noopener noreferrer" className="text-sm text-secondary-600 hover:underline break-all">
                    {selectedApplicant.studentId.linkedIn}
                  </a>
                ) : (
                  <p className="text-sm text-primary-700">Not provided</p>
                )}
              </div>
              <div className="p-3 bg-primary-50 rounded-lg">
                <h3 className="text-xs font-medium text-primary-500 mb-1">GitHub</h3>
                {selectedApplicant.studentId?.github ? (
                  <a href={selectedApplicant.studentId.github} target="_blank" rel="noopener noreferrer" className="text-sm text-secondary-600 hover:underline break-all">
                    {selectedApplicant.studentId.github}
                  </a>
                ) : (
                  <p className="text-sm text-primary-700">Not provided</p>
              ...
              <div className="p-3 bg-primary-50 rounded-lg">
                <h3 className="text-xs font-medium text-primary-500 mb-1">Portfolio</h3>
                {selectedApplicant.studentId?.portfolio ? (
                  <a href={selectedApplicant.studentId.portfolio} target="_blank" rel="noopener noreferrer" className="text-sm text-secondary-600 hover:underline break-all">
                    {selectedApplicant.studentId.portfolio}
                  </a>
                ) : (
                  <p className="text-sm text-primary-700">Not provided</p>
            ...
            <div className="pt-4 border-t border-primary-200">
              ...
              {aiScore && !loadingAiScore && (
                <div className="space-y-4">
                  ...
                  {aiInsights?.profileSummary && (
                    <div className="p-3 bg-blue-50 rounded-lg space-y-2">
                      <h4 className="text-sm font-medium text-primary-800">Profile Summary</h4>
                      <p className="text-sm text-primary-700">{aiInsights.profileSummary.summary}</p>
                      <p className="text-xs text-primary-600">LinkedIn: {aiInsights.profileSummary.linkedinInsight}</p>
                      <p className="text-xs text-primary-600">GitHub: {aiInsights.profileSummary.githubInsight}</p>
                      <p className="text-xs text-primary-600">Use: {aiInsights.profileSummary.recommendedUse}</p>
                    </div>
                  )}

                  {aiInsights?.atsAnalysis && (
                    <div className="p-3 bg-purple-50 rounded-lg space-y-2">
                      <h4 className="text-sm font-medium text-primary-800">ATS Analysis</h4>
                      <div className="flex items-center gap-3">
                        <span className="text-2xl font-bold text-purple-700">{aiInsights.atsAnalysis.atsScore}/100</span>
                        <span className="badge badge-info">{aiInsights.atsAnalysis.atsVerdict}</span>
                      </div>
                      <p className="text-sm text-primary-700">{aiInsights.atsAnalysis.overallFeedback}</p>
                    </div>
                  )}
